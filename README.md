...
```
wget -qO- https://raw.githubusercontent.com/erikerikson/onboarding/0.ssh.sh | bash
```
...
```
wget -qO- https://raw.githubusercontent.com/erikerikson/onboarding/1.setup.sh | bash
```
